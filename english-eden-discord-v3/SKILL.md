---
name: english-eden-discord-v3
description: Ashley英语乐园全流程生产（Notion + Suno + Midjourney Discord/Web）状态机版本。Use when tasks come from Notion with 状态=素材收集 and you need strict phase-based execution, proactive progress reports (phase start/finish), single-main-tab browser control, 3-item batching, dynamic video pacing, audio format normalization, and deterministic fallback when video download cannot be automated.
---
